...
function AboutUs() {
  ...
  return (
    <>
      <Title name="About us" />
      <section className="text-center sm:text-start grid grid-cols-1 sm:grid-cols-2 sm:px-[10vw] px-[5vw] pt-[6vw] w-full gap-[4vw] justify-center items-center">
        ...
        <motion.div
          ...
          className="flex justify-center items-start flex-col w-full h-auto gap-[1vw]"
        >
        ...
        <div className="w-full sm:flex h-full hidden flex items-center justify-center ">
          <motion.div
            ...
            className="bg-cover w-full h-full bg-center bg-[url('/FirstAboutImage.jpg')]"
          />
        </div>
      </section>
      <section
      ...
      >
        <motion.div
          ...
          className="bg-[#F9E8CC] flex justify-center px-[10vw] py-[2vw] items-center flex-col w-full gap-[1vw] text-center"
        >
        ...
        <motion.div
          ...
          className="flex justify-center px-[10vw] py-[2vw] items-center flex-col w-full gap-[1vw] text-center bg-[#E5F0F9]"
        >
          <span className="font-anybody font-semibold text-2xl text-[#242424]">
            Our mission
          </span>
      ...
      <section className="text-center sm:text-start grid sm:grid-cols-2 grid-cols-1 justify-center item-center w-full mt-[8vw] px-[5vw] sm:px-[10vw]">
        <motion.div
          whileHover={{ scale: 1.08 }}
          transition={{
            duration: 0.3,
          ...
          className="w-full h-[60vw] flex items-center justify-center"
        >
        ...
        <motion.div
          ...
          className="flex flex-col justify-center items-center w-full h-fit py-[10vw] sm:py-[1vw] px-[3vw] gap-[0.5vw]"
        >
      ...
      <section className="w-full h-[40%] bg-black bg-[url('/Pattern3.jpg')] bg-cover bg-center mt-[8vw]">
        <div className="flex w-full h-full flex-col items-center justify-center inset-0 bg-[#242424E5]/95 gap-[5vw] p-[4vw]">
          ...
          >
            <div className="flex justify-center flex-col items-center w-full h-auto gap-[2vw] sm:px-[20vw] text-center">
                ...
                {options.map((item, index) =>
                  item.type === "route" ? (
                    <RouterLink
                      ...
                      className={`${
                        isActive
                          ...
                          ? "bg-[#E1781F] hover:bg-[#ff6200]"
                          : "bg-transparent hover:border-[#ff6200]"
                    ...
                    <ScrollLink
                      ...
                      spy={true}
                      key={index}
                      className="border-[#E1781F] hover:text-[#ff6200] hover:border-[#ff6200] cursor-pointer border text-[#E1781F] w-full h-full text-nowrap p-[1vw]"
                    >
                      {item.title}
                    </ScrollLink>
                  )
