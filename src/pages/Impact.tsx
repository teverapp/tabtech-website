    ...
    <>
      ...
      <section className="grid sm:grid-cols-2 grid-cols-1 justify-center items-center w-full py-[5vw] px-[5vw] sm:px-[10vw] gap-[4vw]">
        <motion.div
          ...
          className="w-full sm:hidden flex h-[80vw] bg-[#E7E7E7]"
        />
        <motion.div
          whileHover={{ scale: 1.08 }}
          transition={{
          ...
          className="flex justify-center flex-col items-center w-full p-[2vw] gap-[3vw]"
        >
          <div className="flex flex-col border-b-1 border-b-[#E7E7E7] pb-[2vw] gap-[0.1vw]">
            ...
            <motion.div
              ...
              className="mr-auto px-[4vw] hover:border-[#ff6200] text-[#242424] hover:text-[#ff6200] py-[1vw] border-1"
            >
        ...
        <motion.div
          ...
          className="w-full hidden sm:flex h-full bg-[#E7E7E7]"
        />
      </section>
      <LastSection />
    </>
